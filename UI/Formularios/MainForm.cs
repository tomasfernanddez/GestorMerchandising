    ...
    public partial class MainForm : Form
    {
        ...
        private void AbrirPedidosMuestra()
        {
            try
            {
                ...
                logSvc.LogInfo("Abriendo módulo de pedidos de muestra / Opening sample loan module", "PedidosMuestra", SessionContext.NombreUsuario);

                var f = new PedidosMuestraForm(pedidoMuestraSvc, clienteSvc, productoSvc, bitacoraSvc, logSvc);
                f.FormClosed += (s, e) =>
                {
                    logSvc.LogInfo("Cerrado módulo de pedidos de muestra / Sample loan module closed", "PedidosMuestra", SessionContext.NombreUsuario);
                };
            ...
            {
                var logSvc = ServicesFactory.CrearLogService();
                logSvc.LogError("Error abriendo módulo de pedidos de muestra / Error opening sample loan module", ex, "PedidosMuestra", SessionContext.NombreUsuario);
                MessageBox.Show($"Error: {ex.Message}", Text, MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
